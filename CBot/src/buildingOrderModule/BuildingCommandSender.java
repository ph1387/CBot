...
class BuildingCommandSender implements Command {
	...
	public BuildingCommandSender() {
		
	}

	public BuildingCommandSender(List<Command> commandList, List<Requirement> requirementList) {
		this.commandList = commandList;
		this.requirementList = requirementList;
	}
	
	public BuildingCommandSender(List<Command> commandList) {
	...
	public void insertCommandAt(int index, Command command, Requirement requirement) {
		try {
			...
			System.out.println("---BUILDINGCOMMANDSENDER: failed to insert command at index [" + index + "]---");
		}
	}
	...
	public void execute() {
		...
		try {
			...
			System.out.println("---BUILDINGCOMMAND: error---");
		}
	}
