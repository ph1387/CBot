...
public class ActionUpdaterTerran_Marine extends ActionUpdaterDefault {
	...
	// TODO: UML ADD
	private LoadIntoActionTerran_Bunker loadIntoActionTerran_Bunker;
	...
	public void update(PlayerUnit playerUnit) {
		...
		this.loadIntoActionTerran_Bunker.setTarget(new Object());
	...
	protected void init() {
		...
		this.loadIntoActionTerran_Bunker = (LoadIntoActionTerran_Bunker) this
				.getActionFromInstance(LoadIntoActionTerran_Bunker.class);
	}
